...
useHead({
  title: t('auth.login.title') + ' - AI Studio Photo',
})
    ...
    <div class="w-full max-w-md space-y-8">
      <div class="text-center">
        ...
        <p class="mt-2 text-sm text-gray-600">
          ...
          <NuxtLink to="/signup" class="font-medium text-[#912efb] hover:text-[#7e1fe0]">
      ...
      <div class="mt-8 rounded-lg bg-white px-8 py-10 shadow">
        ...
        <form @submit.prevent="handleLogin" class="space-y-4">
          ...
          <div class="flex items-center justify-between">
            <div class="text-sm">
              <NuxtLink to="/forgot-password" class="font-medium text-[#912efb] hover:text-[#7e1fe0]">
