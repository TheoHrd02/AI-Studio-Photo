        ...
        <div class="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul class="space-y-3 text-sm">
              <li><NuxtLink to="/features" class="text-gray-400 hover:text-white transition-colors">Fonctionnalités</NuxtLink></li>
              <li><NuxtLink to="/pricing" class="text-gray-400 hover:text-white transition-colors">Tarifs</NuxtLink></li>
          ...
          <div>
            ...
            <ul class="space-y-3 text-sm">
              <li><NuxtLink to="/help" class="text-gray-400 hover:text-white transition-colors">Centre d'aide</NuxtLink></li>
