      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-3xl text-center">
          ...
          <div class="mb-5 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-1.5 text-sm font-medium text-white/90 backdrop-blur-sm shadow-sm">
            <span class="h-1.5 w-1.5 flex-shrink-0 animate-pulse rounded-full bg-primary-400" aria-hidden="true" />
            {{ $t('hero.eyebrow') }}
          </div>
          ...
          <div class="mt-10 flex flex-wrap items-center justify-center gap-x-5 gap-y-3">
            ...
            <div class="flex items-center gap-1.5 text-sm font-medium text-white/75">
              ...
              <svg class="h-4 w-4 flex-shrink-0 text-yellow-400" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                <path d="M13 3L4 14h7v7l9-11h-7z" />
              </svg>
              {{ $t('hero.trustChips.speed') }}
            </div>

            <span class="hidden h-3 w-px bg-white/20 sm:block" aria-hidden="true" />

            <div class="flex items-center gap-1.5 text-sm font-medium text-white/75">
              <!-- Check circle — risk reduction signal -->
              <svg class="h-4 w-4 flex-shrink-0 text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5" aria-hidden="true">
            ...
            <div class="flex items-center gap-1.5 text-sm font-medium text-white/75">
              ...
              <svg class="h-4 w-4 flex-shrink-0 text-primary-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true">
            ...
            <div class="flex items-center gap-1.5 text-sm font-medium text-white/75">
              ...
              <svg class="h-4 w-4 flex-shrink-0 text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true">
          ...
          <p class="mt-8 text-xs font-medium text-white/50" aria-label="Audience">
            {{ $t('personas.forLabel') }}
            <span
              ...
              class="inline"
            >
              {{ $t(`personas.${key}.label`) }}<span v-if="i < personaKeys.length - 1" class="mx-1.5" aria-hidden="true">·</span>
            </span>
          </p>
